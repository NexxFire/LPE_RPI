...
TERMINFO="/home/martin/Bureau/Cours/LA1/LPE/Partie2/rootRPI/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/man_alias.sed" ; then
cat >>/home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
CF_EOF2
		echo "...made /home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/man_alias.sed" \
		< "$i" | sed -f /home/martin/Bureau/Cours/LA1/LPE/Partie2/srcRPI/ncurses/edit_man.sed >$TMP
